    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-8 flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Edit Advance</h1>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">Update advance record for {{ $advance->employee->getFullName() }}</p>
                </div>
