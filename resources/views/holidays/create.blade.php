<x-admin-layout>
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-900">Create New Holiday</h1>
        </div>

        <!-- Form -->
        <div class="bg-white shadow rounded-lg">
            <form action="{{ route('holidays.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="e.g., New Year's Day" required
                ...
                <div>
                    ...
                    <select id="type" name="type" required
                        ...
                        <option value="special" {{ old('type') === 'special' ? 'selected' : '' }}>Special Holiday</option>
                    </select>
                    @error('type')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="url" id="memorandum_attachment" name="memorandum_attachment" value="{{ old('memorandum_attachment') }}" placeholder="https://drive.google.com/..."
