<x-admin-layout>
    ...
    <div class="w-full max-w-5xl mx-auto px-2 sm:px-4 lg:px-8 py-6 sm:py-8">
        <!-- Header -->
        <div class="mb-8">
            <a href="{{ route('activities.index') }}" class="text-blue-600 hover:text-blue-900 mb-4 inline-flex items-center">
            ...
            <form action="{{ route('activities.update', $activity) }}" method="POST" class="p-4 sm:p-6 space-y-6" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="employee_id" name="employee_id" required
                                ...
                                @foreach ($employees as $employee)
                                    <option value="{{ $employee->id }}" {{ old('employee_id', $activity->employee_id) == $employee->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="text" id="activity_type" name="activity_type" value="{{ old('activity_type', $activity->activity_type) }}" placeholder="e.g., Training, Travel, Meeting" required
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4" placeholder="Optional description..."
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('description') border-red-500 @enderror">{{ old('description', $activity->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
